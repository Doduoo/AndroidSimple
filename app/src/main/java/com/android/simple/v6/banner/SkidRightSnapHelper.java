    ...
    public int[] calculateDistanceToFinalSnap(
        ...
        if (layoutManager instanceof SkidRightLayoutManager) {
            ...
            if (layoutManager.canScrollHorizontally()) {
                out[0] = ((SkidRightLayoutManager) layoutManager).calculateDistanceToPosition(layoutManager.getPosition(targetView));
            } else {
                out[1] = ((SkidRightLayoutManager) layoutManager).calculateDistanceToPosition(layoutManager.getPosition(targetView));
            }
            return out;
        }
        return null;
